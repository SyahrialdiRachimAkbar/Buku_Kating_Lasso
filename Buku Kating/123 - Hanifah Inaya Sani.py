...
if menu == "Kesekjenan":
    ...
    def senator():
        gambar_urls = [
            "https://drive.google.com/uc?export=view&id=1yQN-LVLlONqKdPDACYmlbRjwSDqYY_Q3", # ka luthfi
            "https://drive.google.com/uc?export=view&id=1yUMNFlsn7ld1h4NV9H4ABXtjotANLksP", # bang bintang
        ]
        data_list = [
            {
